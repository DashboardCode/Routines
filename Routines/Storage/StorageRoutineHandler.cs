...
namespace DashboardCode.Routines.Storage
{
    ...
    public class StorageRoutineHandlerAsync<TUserContext> : IHandlerAsync<RoutineClosure<TUserContext>>
    {
        readonly IOrmHandlerGFactory<TUserContext> ormHandlerGFactory;
        readonly IRepositoryHandlerGFactory<TUserContext> repositoryHandlerGFactory;
        readonly IHandlerAsync<RoutineClosure<TUserContext>> routineHandler;

        public StorageRoutineHandlerAsync(
            IRepositoryHandlerGFactory<TUserContext> repositoryHandlerGFactory,
            IOrmHandlerGFactory<TUserContext> ormHandlerGFactory,
        ...
        public Task<TOutput> HandleAsync<TOutput>(Func<RoutineClosure<TUserContext>, Task<TOutput>> func) =>
            routineHandler.HandleAsync(func);
    ...
    public class StorageHandlerAsync<TUserContext> : IHandlerAsync<RoutineClosure<TUserContext>>
    {
        readonly IOrmHandlerGFactory<TUserContext> ormHandlerGFactory;
        readonly IRepositoryHandlerGFactory<TUserContext> repositoryHandlerGFactory;
        readonly RoutineClosure<TUserContext> closure;

        public StorageHandlerAsync(
            IRepositoryHandlerGFactory<TUserContext> repositoryHandlerGFactory,
            IOrmHandlerGFactory<TUserContext> ormHandlerGFactory,
            RoutineClosure<TUserContext> closure)
        {
    ...
    public class StorageRoutineHandlerOmni<TUserContext> : IHandlerOmni<RoutineClosure<TUserContext>>
    {
        readonly IOrmHandlerGFactory<TUserContext> ormHandlerGFactory;
        readonly IRepositoryHandlerGFactory<TUserContext> repositoryHandlerGFactory;
        readonly IHandlerOmni<RoutineClosure<TUserContext>> routineHandler;

        public StorageRoutineHandlerOmni(
            IRepositoryHandlerGFactory<TUserContext> repositoryHandlerGFactory,
            IOrmHandlerGFactory<TUserContext> ormHandlerGFactory,
    ...
    public class StorageHandlerOmni<TUserContext> : IHandlerOmni<RoutineClosure<TUserContext>>
    {
        readonly IOrmHandlerGFactory<TUserContext> ormHandlerGFactory;
        readonly IRepositoryHandlerGFactory<TUserContext> repositoryHandlerGFactory;
        readonly RoutineClosure<TUserContext> closure;

        public StorageHandlerOmni(
            IRepositoryHandlerGFactory<TUserContext> repositoryHandlerGFactory,
            IOrmHandlerGFactory<TUserContext> ormHandlerGFactory,
            RoutineClosure<TUserContext> closure)
        {
