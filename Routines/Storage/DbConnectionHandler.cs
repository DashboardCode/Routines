...
namespace DashboardCode.Routines.Storage
{
    ...
    public class DbConnectionHandlerAsync<TIService, TUserContext> :
        IRoutineHandlerAsync<(TIService service, Action<Action> tran), TUserContext>
    {
        readonly Func<DbConnection, Action<DbCommand>, TIService> construct;
        readonly Func<DbConnection> createConnection;
        readonly RoutineClosure<TUserContext> closure;

        public DbConnectionHandlerAsync(
            Func<DbConnection, Action<DbCommand>, TIService> construct,
            Func<DbConnection> createConnection,
            RoutineClosure<TUserContext> closure)
        {
    ...
    public class DbConnectionHandlerOmni<TIService, TUserContext> :
        IRoutineHandlerOmni<(TIService service, Action<Action> tran), TUserContext>
    {
        readonly Func<DbConnection, Action<DbCommand>, TIService> construct;
        readonly Func<DbConnection> createConnection;
        readonly RoutineClosure<TUserContext> closure;

        public DbConnectionHandlerOmni(
            Func<DbConnection, Action<DbCommand>, TIService> construct,
            Func<DbConnection> createConnection,
            RoutineClosure<TUserContext> closure)
        {
