...
-targetargs:"/testcontainer:\"%~dp0Tests\AdminkaV1.Injected.Test\bin\Debug\Vse.AdminkaV1.Injected.Test.dll\" /testcontainer:\"%~dp0Tests\Routines.Test\bin\Debug\Vse.Routines.Test.dll\" /testcontainer:\"%~dp0Tests\Routines.Configuration.Test\bin\Debug\Vse.Routines.Configuration.Test.dll\" /testcontainer:\"%~dp0Tests\AdminkaV1.Wcf.Client.Test\bin\Debug\Vse.AdminkaV1.Wcf.Client.Test.dll\" /resultsfile:\"%~dp0TestResults\AdminkaV1.Injected.Test.trx\"" ^
-mergebyhash ^
-skipautoprops ^
