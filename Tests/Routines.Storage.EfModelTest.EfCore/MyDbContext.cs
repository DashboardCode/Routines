...
namespace DashboardCode.Routines.Storage.EfModelTest.EfCoreTest
{
    public class MyDbContext : DbContext
    {
        ...
        private static DbContextOptions<MyDbContext> CreateOptions(
            ...
            //,string connectionString, bool inMemory=false
            )
        {
        ...
        public MyDbContext(Action<DbContextOptionsBuilder<MyDbContext>> buildOptionsBuilder/*string connectionString, bool inMemory=false, */)
            : base(CreateOptions(buildOptionsBuilder))
        {
        }
        public MyDbContext(Action<DbContextOptionsBuilder<MyDbContext>> buildOptionsBuilder, /*string connectionString,*/ MyLoggerProvider loggerProvider/*, bool inMemory = false*/)
            : base(CreateOptions(buildOptionsBuilder))
        {
