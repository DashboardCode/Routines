...
namespace DashboardCode.AdminkaV1.DataAccessEfCore.SqlServer.InstallerApp.Migrations
{
    ...
    [Migration("20180113011543_Initial")]
            ...
            modelBuilder.Entity("DashboardCode.AdminkaV1.AuthenticationDom.Group", b =>
                {
                    ...
                    b.HasAnnotation("Constraints", new Constraint[]{new DashboardCode.Routines.Storage.Constraint(){Name="CK_scr_Groups_GroupName", Body=@"CHECK(GroupName NOT LIKE '%[^a-z0-9 ]%')", Message=@"[^a-z0-9 ]", Fields=new[] {"GroupName"}},new DashboardCode.Routines.Storage.Constraint(){Name="CK_scr_Groups_GroupAdName", Body=@"CHECK(GroupAdName NOT LIKE '%[^a-z!.!-!_!\!@]%' ESCAPE '!')", Message=@"[^a-z!.!-!_!\!@]", Fields=new[] {"GroupAdName"}},});
                });
            ...
            modelBuilder.Entity("DashboardCode.AdminkaV1.AuthenticationDom.Privilege", b =>
                {
                    ...
                    b.HasAnnotation("Constraints", new Constraint[]{new DashboardCode.Routines.Storage.Constraint(){Name="CK_scr_Privileges_PrivilegeId", Body=@"CHECK(PrivilegeId NOT LIKE '%[^a-z0-9]%')", Message=@"[^a-z0-9]", Fields=new[] {"PrivilegeId"}},});
                });
            ...
            modelBuilder.Entity("DashboardCode.AdminkaV1.AuthenticationDom.Role", b =>
                {
                    ...
                    b.HasAnnotation("Constraints", new Constraint[]{new DashboardCode.Routines.Storage.Constraint(){Name="CK_scr_Roles_RoleName", Body=@"CHECK(RoleName NOT LIKE '%[^a-z0-9 ]%')", Message=@"[^a-z0-9 ]", Fields=new[] {"RoleName"}},});
                });
            ...
            modelBuilder.Entity("DashboardCode.AdminkaV1.AuthenticationDom.User", b =>
                {
                    ...
                    b.HasAnnotation("Constraints", new Constraint[]{new DashboardCode.Routines.Storage.Constraint(){Name="CK_scr_Users_LoginName", Body=@"CHECK(LoginName NOT LIKE '%[^a-z!.!-!_!\!@]%' ESCAPE '!')", Message=@"[^a-z!.!-!_!\!@] ESCAPE '!'", Fields=new[] {"LoginName"}},new DashboardCode.Routines.Storage.Constraint(){Name="CK_scr_Users_SecondName", Body=@"CHECK(SecondName NOT LIKE '%[^a-z '']%')", Message=@"[^a-z '']", Fields=new[] {"SecondName"}},new DashboardCode.Routines.Storage.Constraint(){Name="CK_scr_Users_FirstName", Body=@"CHECK(FirstName NOT LIKE '%[^a-z ]%')", Message=@"[^a-z ]", Fields=new[] {"FirstName"}},});
                });
            ...
            modelBuilder.Entity("DashboardCode.AdminkaV1.TestDom.TypeRecord", b =>
                {
                    ...
                    b.HasAnnotation("Constraints", new Constraint[]{new DashboardCode.Routines.Storage.Constraint(){Name="CK_tst_TypeRecords_TypeRecordName", Body=@"CHECK(TypeRecordName NOT LIKE '%[^a-z0-9 ]%')", Message=@"TypeRecordName NOT LIKE '%[^a-z0-9 ]%'", Fields=new[] {"TypeRecordName"}},});
                });
