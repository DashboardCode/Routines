...
//        #region Compose
//        public static Func<ConfigurableController, Task<IActionResult>> Compose(Func<MetaRoutineHandler, Task<IActionResult>> func)
//            => controller => func(new MetaRoutineHandler(controller));
...
//        {
//            var routine = new MetaRoutineHandler(controller);
