...
module Usaprl2 {
    ...
    */
    ...
    export class Workflow {
        ...
        public LogError(ex: any, stack: string) {
            //if (ex == null) return;
        ...
        public ShowErrorDialogJs(ex: any, bufferText: string) //: JQueryPromise<any>
        {
            //var template =
            //    $('<div><div><p>'
            //        + '<b>Exception Message: </b><span class="erdExceptionMessage"></span><br />'
        ...
        /*
        private ShowExpandableDialog(title: string, message: string, template: JQuery): JQueryPromise<any> {
