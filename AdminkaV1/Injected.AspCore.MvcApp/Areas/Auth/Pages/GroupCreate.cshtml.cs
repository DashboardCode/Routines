...
namespace DashboardCode.AdminkaV1.Injected.AspCore.MvcApp.Areas.Auth.Pages
{
    public class GroupCreateModel : PageModel
    {
        ...
        {
            var insert = CrudRoutinePageConsumer<UserContext, User, Group, int>.ComposeCreate(
                this,
                (e) => this.Entity = e,
        ...
        public Task<IActionResult> OnPostAsync()
        {
            ...
            var insertConfirmed = CrudRoutinePageConsumer<UserContext, User, Group, int>.ComposeCreateConfirmed(
                this,
                (e) => this.Entity = e,
                prf => BackwardUrl = prf.BackwardUrl,
                "Groups",
