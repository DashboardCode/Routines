...
namespace DashboardCode.AdminkaV1.Injected.NETStandard.EfCoreMigrationApp.Migrations
{
    ...
    [Migration("20180419124155_MigrationName")]
            ...
            modelBuilder.Entity("DashboardCode.AdminkaV1.AuthenticationDom.Group", b =>
                {
                    ...
                    b.HasAnnotation("Constraints", new  Constraint[]{new Constraint(){Name="CK_scr_Groups_GroupName", Body=@"CHECK (GroupName NOT LIKE '%[^a-z0-9!:!.!-!_!\!@! ]%' ESCAPE '!')", Message=@"Only letters, numbers, space and .-_@:", Fields=new[] {"GroupName"}},new Constraint(){Name="CK_scr_Groups_GroupAdName", Body=@"CHECK (GroupAdName NOT LIKE '%[^a-z0-9!.!-!_!\!@]%' ESCAPE '!')", Message=@"Only letters, numbers and .-_@", Fields=new[] {"GroupAdName"}},});
                });
            ...
            modelBuilder.Entity("DashboardCode.AdminkaV1.AuthenticationDom.Privilege", b =>
                {
                    ...
                    b.HasAnnotation("Constraints", new  Constraint[]{new Constraint(){Name="CK_scr_Privileges_PrivilegeId", Body=@"CHECK (PrivilegeId NOT LIKE '%[^a-z0-9]%')", Message=@"Only letters and numbers", Fields=new[] {"PrivilegeId"}},});
                });
            ...
            modelBuilder.Entity("DashboardCode.AdminkaV1.AuthenticationDom.Role", b =>
                {
                    ...
                    b.HasAnnotation("Constraints", new  Constraint[]{new Constraint(){Name="CK_scr_Roles_RoleName", Body=@"CHECK(RoleName NOT LIKE '%[^a-z0-9 ]%')", Message=@"[^a-z0-9 ]", Fields=new[] {"RoleName"}},});
                });
            ...
            modelBuilder.Entity("DashboardCode.AdminkaV1.AuthenticationDom.User", b =>
                {
                    ...
                    b.HasAnnotation("Constraints", new  Constraint[]{new Constraint(){Name="CK_scr_Users_LoginName", Body=@"CHECK (LoginName NOT LIKE '%[^a-z0-9!.!-!_!\!@]%' ESCAPE '!')", Message=@"Only letters, numbers and .-_@", Fields=new[] {"LoginName"}},new Constraint(){Name="CK_scr_Users_SecondName", Body=@"CHECK (SecondName NOT LIKE '%[^a-z '']%')", Message=@"Only letters, space and apostrophe", Fields=new[] {"SecondName"}},new Constraint(){Name="CK_scr_Users_FirstName", Body=@"CHECK (FirstName NOT LIKE '%[^a-z ]%')", Message=@"Only letters and space", Fields=new[] {"FirstName"}},});
                });
            ...
            modelBuilder.Entity("DashboardCode.AdminkaV1.TestDom.TypeRecord", b =>
                {
                    ...
                    b.HasAnnotation("Constraints", new  Constraint[]{new Constraint(){Name="CK_TypeRecords_TypeRecordName", Body=@"CHECK (TypeRecordName NOT LIKE '%[^a-z0-9 ]%')", Message=@"Only letters, numbers and space", Fields=new[] {"TypeRecordName"}},});
                });
