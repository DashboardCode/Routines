            ...
            modelBuilder.Entity("DashboardCode.AdminkaV1.AuthenticationDom.Group", b =>
                {
                    ...
                    b.HasAnnotation("Constraints", new  DashboardCode.AdminkaV1.DataAccessEfCore.Constraint[]{new DashboardCode.AdminkaV1.DataAccessEfCore.Constraint(){Name="CK_scr_Groups_GroupName", Body=@"CHECK (GroupName NOT LIKE '%[^a-z0-9!:!.!-!_!\!@! ]%' ESCAPE '!')", Message=@"Only letters, numbers, space and .-_@:", Fields=new[] {"GroupName"}},new DashboardCode.AdminkaV1.DataAccessEfCore.Constraint(){Name="CK_scr_Groups_GroupAdName", Body=@"CHECK (GroupAdName NOT LIKE '%[^a-z0-9!.!-!_!\!@]%' ESCAPE '!')", Message=@"Only letters, numbers and .-_@", Fields=new[] {"GroupAdName"}},});
                });
